package edu.rosehulman.comicviewer
...
object Utils {
    ...
    fun IntArray.random() = if (size > 0) get(Random().nextInt(size)) else null


    fun randomCleanIssueNumber(): Int {
        return sCleanIssues.random()!!
    }

    private val sCleanIssues = intArrayOf(
        1558, // Roombas. (120)
        1557, // Recursion. (230)
